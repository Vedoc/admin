ActiveAdmin.register Shop do
  ...
  #
  # permit_params :name, :owner_name, :hours_of_operation, :techs_per_shift, :certified, :lounge_area, :supervisor_permanently, :languages, :tow_track, :complimentary_inspection, :vehicle_diesel, :vehicle_electric, :vehicle_warranties, :categories, :location, :address, :phone, :approved, :avatar, :additional_info, :average_rating
  #
  # or
  #
  # permit_params do
  #   permitted = [:name, :owner_name, :hours_of_operation, :techs_per_shift, :certified, :lounge_area, :supervisor_permanently, :languages, :tow_track, :complimentary_inspection, :vehicle_diesel, :vehicle_electric, :vehicle_warranties, :categories, :location, :address, :phone, :approved, :avatar, :additional_info, :average_rating]
